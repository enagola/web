...
<body>
    <div type="hidden" id='demo' style='display: none;text-align: center;padding-top: 25px;'>
      <embed src="https://enagola.github.io/web/CSE203B.pdf" position="fixed" top="0px" bottom="0px" right="0px" width="100%" border="none" margin="0" padding="0" overflow="hidden" z-index="999999" height="100%"/>
    </div>
