...
# Reference Picamera Object Detection Using Tensorflow Classifier

## some is copied from Evan Juras's example at
...
if camera_type == 'picamera':
    ...
    for frame1 in camera.capture_continuous(rawCapture, format="bgr",use_video_port=True):
        ...
        labels, _ = vis_util.visualize_boxes_and_labels_on_image_array(
            frame,
            np.squeeze(boxes),
